...
第一階段建立安全心跳與硬體／模型狀態回報。第二、三階段加入受限工作佇列與 GPU OCR。v0.6.10 支援司法院 RAR 全量斷點拆解、既有測試結果補傳、分批入庫、後台進度回報，並會自動升級舊版司法進度資料庫。原始 PDF、Word、影片與 RAR 都留在公司電腦，雲端只接收可搜尋的裁判全文、文字索引或播放所需檔案。
