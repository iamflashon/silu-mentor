...
export const defaultPengliModules: PortalModule[] = [
  ...
  { id: "notes", enabled: true, order: 7, label: "我的筆記", description: "保存法條、頁數與學習解釋。", href: "/teachers/pengli/notes", action: "route", icon: "記" },
  { id: "question-bank", enabled: false, order: 8, label: "行政法題庫", description: "把教材考點整理成可練習題目。", href: "/teachers/pengli/questions", action: "route", icon: "題" },
];
