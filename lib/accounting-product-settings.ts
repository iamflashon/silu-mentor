...
const fallback = { productKey:ACCOUNTING_FIRST_PRODUCT_KEY,title:ACCOUNTING_FIRST_PRODUCT_TITLE,subtitle:"依章節、學校與年度練習研究所中級會計選擇題",descriptionHtml:"<p>收錄會研所中級會計選擇題、完整計算過程與老師解析。</p>",listPrice:249,salePrice:null as number|null,saleLabel:"",saleStartsAt:null as Date|null,saleEndsAt:null as Date|null,accessDays:90,trialQuestions:10,renewalMode:"extend",status:"draft",sortOrder:10 };
