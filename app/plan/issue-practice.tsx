...
type SavedRecord = { studentIssues: string; studentSupplement: string; sampleLevel?: SampleLevel | null; lunaResult: Result | null; solResult: Result | null; updatedAt: string };
...
export function IssuePractice() {
  ...
  async function choose(value: number) {
    setQuestionId(value); setStudentIssues(""); setStudentSupplement(""); setSampleLevel(null); setResults({}); setActiveResult("luna"); setSavedNotice(""); setError("");
    if (!value) return;
