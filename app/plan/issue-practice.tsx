...
function PersonalIssuePractice({ onBack }: { onBack: () => void }) {
  ...
  const [loading, setLoading] = useState<"ocr" | "save" | "load" | "analyze" | null>(null);
