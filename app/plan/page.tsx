...
export default function StudyPlanPage() {
  ...
  async function askCourseAi(prompt: string, imageDataUrl = "") {
  ...
  function submitCourseQuestion(event: FormEvent) {
    ...
    void askCourseAi(question, courseCapture);
  }
