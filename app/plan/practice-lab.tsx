...
export function PracticeLab({ initialType }: Props) {
  ...
  function insertEssayMarker(marker: string) {
    setEssay((current) => `${current}${current && !current.endsWith("\n") ? "\n" : ""}${marker}`);
  }
