...
const rules = [
  ["章節／隨機題目包", "NT$30／包", "任選一包 30 題免費體驗一次；完成前一關後，每包最多 2 次答題挑戰，每題 5 秒，另有一次轉轉樂，最高五折；每天再有一次 30 題終極挑戰，3 分鐘內全對可用優惠價 NT$3 購買；購買後 7 天內不限次數重做。"],
...
export default function MedtechPricingPage() {
  return <main className="medtech-pricing-page">
    ...
    <section className="medtech-pricing-head">
      <span>簡單點數制</span>
      <h1>不用訂閱，按照使用方式扣點。</h1>
      <p>題目包直接以新台幣計價；任選一包免費初體驗，其餘每包 NT$30。完成前一關後，下一包可挑戰隨機 10 題，每題限時 5 秒，每包最多 2 次，並可抽一次限時轉轉樂，最高五折；每天另有一次 30 題終極挑戰，3 分鐘內全對可用優惠價 NT$3 購買。</p>
    </section>
    <section className="medtech-pricing-card">
      ...
      <div className="medtech-pricing-note"><b>闖關優惠怎麼玩？</b><span>每包 30 題，購買後 7 天內不限次數重做；完成前一關後可挑戰隨機 10 題，每題 5 秒，每包最多 2 次，答對率與平均速度越好，折扣越優惠，兩次取最佳結果；另可抽一次轉轉樂，最高五折。每天還有一次 30 題終極挑戰，題目與選項重新打亂，3 分鐘內全對即可用優惠價 NT$3 購買下一關。全真模擬 120 題另有 NT$60 一次購足方案。</span></div>
