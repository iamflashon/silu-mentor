...
export default function MedtechHome() {
  return <main className="medtech-home">
    ...
    <section className="medtech-hero"><div><span>臨床病毒學 · 正式題庫</span><h1>為從事醫事檢驗（醫檢師）取得證照及入門基礎</h1><div className="medtech-hero-actions" data-no-navigation-feedback><a href="/medtech/practice">開始隨機 30 題</a><a href="/medtech/ai-study">進入引導學習</a></div></div><aside><small>已匯入正式題庫</small><b>1,484</b><span>題 · 臨床病毒學</span><dl><div><dt>來源</dt><dd>臨床病毒學（下）</dd></div><div><dt>狀態</dt><dd>教材原稿答案</dd></div><div><dt>作答</dt><dd>隨機抽題／整回交卷</dd></div></dl></aside></section>
  </main>;
}
