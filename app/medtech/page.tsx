...
export default async function MedtechHome() {
  ...
  return <main className="medtech-home">
    ...
    <section className="medtech-hero"><div><span>臨床病毒學 · 正式題庫</span><h1>助您取得醫檢師證照</h1><div className="medtech-hero-actions" data-no-navigation-feedback><a href="/medtech/practice">開始隨機 30 題</a><a href="/medtech/ai-study">進入引導學習</a><a href="/medtech/upgrade">查看方案（測試付款）</a></div></div><aside><small>已匯入正式題庫</small><b>1,493 <em>題</em></b><span>臨床病毒學</span></aside></section>
  </main>;
}
