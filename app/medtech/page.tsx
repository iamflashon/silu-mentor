...
export default async function MedtechHome() {
  ...
  return <main className="medtech-home">
    ...
    <section className="medtech-home-points"><div><span>點數制｜單純透明</span><h2>用多少，扣多少</h2><p>首次登入贈 10 點；看一題 1 點、語音解析 1 點、AI 追問 1 點。120 題全刷只要 60 點，五折優惠。</p></div><a href="/medtech/upgrade">查看點數方式 →</a></section>
