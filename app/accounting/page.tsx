...
export default async function AccountingHome() {
  ...
  return <main className="accounting-books-page">
    <header className="accounting-top">
      ...
      <nav><a href="/accounting/study-room">學霸讀書室</a><a href="/accounting/qa">課業答疑</a></nav>
    </header>
    ...
    <article className="accounting-book-product">
      ...
      <div><small>會研所中級會計 · 章節題庫</small><h2>{p.title}</h2><div className="accounting-book-rich" dangerouslySetInnerHTML={{__html:p.descriptionHtml}}/><ul><li>依18章逐題練習</li><li>題幹、選項、計算過程與老師解析完整富文呈現</li><li>錯題重練、收藏與學習紀錄</li><li>購買日起使用 {p.accessDays} 天</li></ul><div className="accounting-book-actions"><a className="accounting-book-entry" href="/accounting/practice">免費試做前 {p.trialQuestions} 題 →</a><a className="accounting-book-study" href="/accounting/study-room">進入學霸讀書室</a></div></div>
