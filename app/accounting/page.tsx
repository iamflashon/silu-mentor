...
export default function AccountingHome(){return <main className="accounting-home">
 ...
 <section className="accounting-hero accounting-help-hero"><div><span>中級會計學 · Luna 助教答疑</span><h1>有哪裡不懂，<br/>直接問就好</h1><p>觀念、準則、計算、分錄或老師上課沒聽懂的地方，都能打字、貼截圖或拍照提問。不必先選書，也不必先選章節。</p><div><a href="#accounting-coach">開始問 Luna 助教</a><a href="/accounting/practice">練選擇題真題</a><a href="/accounting/essay">老師帶我解申論</a></div></div><aside><span>三個入口，各做一件事</span><ol><li><b>01</b>首頁：單純課業答疑</li><li><b>02</b>練真題：只練選擇題</li><li><b>03</b>解申論：挑題後由老師逐步帶解</li></ol></aside></section>
 <AccountingCoach />
 </main>}
