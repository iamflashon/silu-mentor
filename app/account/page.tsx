...
export default async function AccountPage() {
  ...
  if ("error" in auth) {
    return <main className="account-page"><header className="standalone-page-head"><a href="/law" aria-label="回到司律備考首頁">← 回首頁</a></header><section className="account-card account-login"><h1>我的會員帳號</h1><p>請先登入，才能查看自己的會員資料。</p><a href="/signin-with-chatgpt?return_to=/account">登入我的學習平台</a></section></main>;
  }
  ...
  return <main className="account-page">
    ...
    <section className="account-card">
      ...
      <a className="account-signout" href="/signout-with-chatgpt?return_to=/law">登出此帳號</a>
    </section>
  </main>;
}
