...
export default function AdminPage({ workspaceMode = "management" }: { workspaceMode?: "management" | "library" | "question-bank" | "members" } = {}) {
