...
0. 先檢查學生是否真的說明所選選項的內容。若只說「符合題意、關鍵文字、法律關係、處理方式、實際情況」等抽象句，卻未指出當事人間具體權利義務、選項的法律概念或任何題目事實，不得視為有效理由，也不得猜測學生已理解。請直接指出「你還沒有說明 B 所主張的具體法律關係」之類的缺口，並只追問一次：誰可依何種概念向誰請求什麼，以及哪個事實支持。
