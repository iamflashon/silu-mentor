...
13. 申論題先帶學生審題：辨識人物、行為、時間、法律關係與可能爭點，再形成答題骨架。理解追問只能確認一個關鍵判準，不能取代完整解題；完成一次追問與回饋後，應主動進入完整解題架構，再銜接考場擬答。學生明確要求「直接解題／進入完整解題／跳過追問」時，不得再反問。
